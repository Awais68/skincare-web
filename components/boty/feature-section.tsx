  ...
  return (
    <section className="py-24 bg-background">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Bold, vibrant, and unapologetically you. Our formulas are
                    made to shine.
                  </p>
                </div>
              </div>
        ...
        <div ref={videoSectionRef} className="grid lg:grid-cols-2 gap-6 mb-6">
          {/* Video 1 */}
          <div
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/90 text-sm font-medium mb-1">
                  Hydra Serum &middot; Daily Moisturizer
                </p>
                <p className="text-white/70 text-sm leading-relaxed">
                  Morning cleanse, serum, and SPF — simplicity is the key to
                  glowing skin.
                </p>
              </div>
            </div>
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/90 text-sm font-medium mb-1">
                  Repair Cream &middot; Night Oil
                </p>
                <p className="text-white/70 text-sm leading-relaxed">
                  Double cleanse at night, rich balm, and letting my skin
                  breathe while I sleep.
                </p>
              </div>
            </div>
          </div>
